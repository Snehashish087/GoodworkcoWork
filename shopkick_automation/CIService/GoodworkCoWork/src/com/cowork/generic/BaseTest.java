...
public class BaseTest implements AutoConstVariables
{
	...
	public void startReport()
	{
		...
		extent.addSystemInfo("Host Name", "E-Governments")
		.addSystemInfo("Environment", "Automation Testing")
		.addSystemInfo("User Name", "Snehashish Chakraborty")
		.addSystemInfo("Domain Name","Gmail");
		//loading the external xml file (i.e., extent-config.xml) which was placed under the base directory
		//You could find the xml file below. Create xml file in your project and copy past the code mentioned below
		//extent.loadConfig(new File(System.getProperty("user.dir")+"\\extent-config.xml"));
		extent.loadConfig(new File("./extent-config/extent-config.xml"));
	}
	...
	{	
		...
		PropertyConfigurator.configure("./log-config/UILogger");
	...
	public static void sendMail() throws MessagingException 
	{
		...
		String uiExtentReport = "./extent-report/STMExtentReport.html";
		String uiLoggerReport = "./logger-report/UI/application.html";
		String testNGIndexReport = "./test-output/index.html";
		String testNGEmailableReport = "./test-output/emailable-report.html";
		...
		message.addRecipients(Message.RecipientType.TO, "snehashish.chakraborty@goodworklabs.com ");
		...
		messageBodyPart.setText("Hi,"
				...
				+ "\n\n This is an auto-generated mail. Please download the reports and open in the browser.");
